...
{
  mCamera->setPosition(Ogre::Vector3(250, 350, -230));
  mCamera->lookAt(Ogre::Vector3(250, 280, 250));
...
mSceneMgr->setFog(Ogre::FOG_EXP2, fadeColour, 0.002);
  ...
  Ogre::SceneNode* ninjaNode = mSceneMgr->getRootSceneNode()->createChildSceneNode(Ogre::Vector3(250,225,50));
  ninjaNode->attachObject(ninjaEntity);


  Ogre::Entity* ogreEntity = mSceneMgr->createEntity("ogrehead.mesh");
  ogreEntity->setCastShadows(true);
  //mSceneMgr->getRootSceneNode()->createChildSceneNode()->attachObject(ogreEntity);
  Ogre::SceneNode* ogreNode = ninjaNode->createChildSceneNode(Ogre::Vector3(100,50,0));
  ...
  spotLightNode->setDirection(-1, 0, 0);
  spotLightNode->setPosition(Ogre::Vector3(150, 325, 50));
  spotLight->setSpotlightRange(Ogre::Degree(35), Ogre::Degree(50));

  Ogre::Light* spotLight2 = mSceneMgr->createLight("SpotLight2");
  spotLight2->setDiffuseColour(1.0, 0, 1);
  spotLight2->setSpecularColour(1.0, 0, 1);
  spotLight2->setType(Ogre::Light::LT_SPOTLIGHT);

  Ogre::SceneNode* spotLightNode2 = mSceneMgr->getRootSceneNode()->createChildSceneNode();
  spotLightNode2->attachObject(spotLight2);
  spotLightNode2->setDirection(0, 0, -1);
  spotLightNode2->setPosition(Ogre::Vector3(250, 325, -230));
